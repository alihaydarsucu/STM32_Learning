...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : 03_ADC_Read - Analog read from a potentiometer via ADC1
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
  ...
  /* Calibrate and start continuous conversion */
  ...
  while (1)
  {
    if (HAL_ADC_PollForConversion(&hadc1, 100) == HAL_OK)
    {
      ...
      adc_voltage = (adc_val / 4095.0f) * 3.3f; /* 12-bit, reference 3.3 V */

      int len = snprintf(uart_buf, sizeof(uart_buf),
                         "ADC Raw: %u\tVoltage: %.2f V\r\n", adc_val, (double)adc_voltage);
...
/**
  ...
  *        Single channel on ADC1_IN0 (PA0), 12-bit, continuous mode.
  * @param None
  * @retval None
  */
static void MX_ADC1_Init(void)
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : PA0 - ADC input (analog) */
